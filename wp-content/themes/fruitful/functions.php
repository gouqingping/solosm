...
/**
 * Sets up theme defaults and registers support for various Solo SM features.
 *
...
if (!class_exists('ffs')){
	function fruitful_shortcodes_admin_notice(){
		echo '<div class="updated"><p>';
			...
			echo '<a href="http://Solo SM.org/plugins/fruitful-shortcodes/" target="_blank">Fruitful Shortcodes</a>';
