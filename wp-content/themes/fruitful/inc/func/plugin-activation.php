<?php
/**
 * Plugin installation and activation for Solo SM themes.
 *
...
if ( ! class_exists( 'TGM_Plugin_Activation' ) ) {
     ...
     * The plugins can be either pre-packaged, downloaded from the Solo SM
    ...
    class TGM_Plugin_Activation {
        ...
        public function __construct() {
            ...
            // Set the current Solo SM version.
            global $wp_version;
        ...
        /**
         * Initialise the interactions between this class and Solo SM.
         *
        ...
        protected function do_plugin_install() {
            ...
            if ( isset( $_GET['plugin'] ) && ( isset( $_GET['fruitful-install'] ) && 'install-plugin' == $_GET['fruitful-install'] ) ) {
                ...
                // Set plugin source to Solo SM API link if available.
            ...
            if ( ! empty( $message ) ) {
                ...
                foreach ( $message as $type => $plugin_groups ) {
                    ...
                    foreach ( $plugin_groups as $plugin_group_single_name ) {
                        ...
                        elseif ( ! $source || preg_match( '|^http://Solo SM.org/extend/plugins/|', $source ) ) {
                            $url = add_query_arg(
                                array(
    ...
    class TGMPA_List_Table extends WP_List_Table {
        ...
        protected function _gather_plugin_data() {
            ...
            foreach ( TGM_Plugin_Activation::$instance->plugins as $plugin ) {
                ...
                // The plugin is from the Solo SM repository.
                else {
                    $table_data[$i]['source'] = __( 'Solo SM Repository', 'fruitful' );
                }
        ...
        public function process_bulk_actions() {
            ...
            if ( 'fruitful-bulk-install' === $this->current_action() ) {
                ...
                // Loop through each plugin to install and try to grab information from Solo SM API, if not create 'fruitful-empty' scalar.
                $i = 0;
 ...
 * we load it here.
 *
 * We check to make sure no action or activation keys are set so that Solo SM
