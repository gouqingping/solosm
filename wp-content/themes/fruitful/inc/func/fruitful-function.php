...
return array(
				...
				/*footer*/			 
				'footer_text'	 => esc_attr__( 'Fruitful theme by', 'fruitful' ) . ' <a href="' . esc_url(__('http://fruitfulcode.com','fruitful')) . '">' . esc_attr__( 'fruitfulcode', 'fruitful' ) . '</a> ' . esc_attr__( 'Powered by:', 'fruitful' ) . ' <a href="' . esc_url(__('http://Solo SM.org','fruitful')) . '">' . esc_attr__( 'Solo SM', 'fruitful' ) . '</a>', 
