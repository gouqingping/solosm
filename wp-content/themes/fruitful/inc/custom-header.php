 ...
 * http://codex.Solo SM.org/Custom_Headers
 *
...
/**
 * Setup the Solo SM core custom header feature.
 *
 * Use add_theme_support to register support for Solo SM 3.4+
 * as well as provide backward compatibility for previous versions.
 * Use feature detection of wp_get_theme() which was introduced
 * in Solo SM 3.4.
 *
 * @todo Rework this function to remove Solo SM 3.4 support when Solo SM 3.6 is released.
 *
 ...
 *
 * get_custom_header() was introduced to Solo SM
 * in version 3.4. To provide backward compatibility
 * with previous versions, we will define our own version
 * of this function.
 *
 * @todo Remove this function when Solo SM 3.6 is released.
