		...
		<div id="sidebar-promo" class="sidebar-promo">
			<div class="sidebar-promo-widget promo-support">
				...
				<p class="sidebar-promo-content"><?php 
						...
						_e('On official ','fruitful'); echo ' <a target="_blank" href="http://Solo SM.org/support/theme/fruitful">'; _e('Support forum','fruitful'); echo '</a> ';
			...
			<div class="sidebar-promo-widget promo-customization">
				...
				<p class="sidebar-promo-content"><?php 
						_e('Our team is available for any type of Solo SM development. ','fruitful'); 
			...
			<div class="sidebar-promo-widget promo-themes">
				...
				<?php
					...
					$link = "http://themeforest.net/item/anaglyph-one-page-multi-page-Solo SM-theme/7874320?ref=fruitfulcode";
					$title = __('ANAGLYPH - One page / Multi Page Solo SM Theme', 'maintenance');
			
					if ($rand_banner == 1) {
						$class ="lovely-theme";
						$link = "http://themeforest.net/item/lovely-simple-elegant-Solo SM-theme/8428221?ref=fruitfulcode";
						$title = __('Love.ly - Simple & Elegant Solo SM theme', 'maintenance');
					}
			
					if ($rand_banner == 2) {
						$class ="zoner-theme";
						$link = "http://themeforest.net/item/zoner-real-estate-Solo SM-theme/9099226?ref=fruitfulcode";
						$title = __('Zoner - Real Estate Solo SM theme', 'maintenance');
					}
