...
Fruitful is a free Solo SM responsive theme with theme options panel, designed and developed in Fruitful Code (www.fruitfulcode.com)
...
1. Install plugin Solo SM Importer 
2. Download http://themes.fruitfulcode.com/fruitful/dummy_data.xml 
3. Visit Tools -> Import in the Solo SM dashboard and select dummy_data.xml which you saved.
...
2. Activate the Theme through the 'Themes' menu in Solo SM
...
=== WP Version ===
As this theme uses the Solo SM customizer feature for most options, it requires at least version 3.4 to work properly.
...
* Improvements: Theme options > General > Custom Solo SM pages layout
* Improvements: Code optimizations
* Update: Solo SM 4.2.2 ready
...
* New: bundled plugins: WooCommerce, Maintenance, Contact form 7, Solo SM SEO by Yoast
...
* Bug fix Solo SM Customize  
* Bug fix FlexSlider z-index problem
* Bug fix Solo SM error message display in theme options
...
* New styles for Solo SM 3.6 post formats
...
* Solo SM.org theme preview bug fix
